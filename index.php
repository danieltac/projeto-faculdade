...
<div class="middle">
      <div id="login">
        ...
        <form action="/faculdade/conexao/login.php" method="POST">
          ...
          <fieldset class="clearfix">
            ...
            <p><span class="fa fa-lock"></span><input name= "id" type="password"  Placeholder="Senha" required></p> <!-- JS because of IE support; better: placeholder="Password" -->
             ...
             <div>
                                <span style="width:48%; text-align:left;  display: inline-block;"><a class="small-text" href="#">Senha = Matrícula</a></span>
